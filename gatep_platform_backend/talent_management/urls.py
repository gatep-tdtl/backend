...
###################### interview bot urls ##########################
    ...
    path('skills-passport/', SkillsPassportView.as_view(), name='skills-passport-api'),
]
